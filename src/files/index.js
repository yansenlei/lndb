...
class fileManager {
  ...
  get(id) {
    this.initFolder(this.base.$DBPathFolder, this.datapath, path.join(this.datapath, id))
  ...
  set(id, value) {
    ...
    if(typeof value === 'object') {
      fs.writeFileSync(path.join(idpath, this.base.$DATA_NAME), JSON.stringify(value))
